...
class CEMPolicy(Policy):
  ...
  # TODO(b/129781271): Replace t2r_model with pack feature function.
  def __init__(self,
               t2r_model,
               action_size=2,
               cem_iters=3,
  ...
  def SelectAction(self, state, context, timestep):  # pylint: disable=invalid-name
    ...
    def objective_fn(samples):
      ...
      # TODO(b/116341909): remove this disable when the bug is fixed
...
class LSTMCEMPolicy(CEMPolicy):
  ...
  def SelectAction(self, state, context, timestep):
    ...
    def objective_fn(samples):
      ...
      # TODO(b/116341909): remove this disable when the bug is fixed
      # pytype: disable=attribute-error
      # TODO(b/129781588): Replace t2r_model with pack feature function.
...
class RegressionPolicy(Policy):
  ...
  # TODO(b/129782773): Replace t2r_model with pack feature function.
...
class OUExploreRegressionPolicy(Policy):
  ...
  # TODO(b/129783035): Replace t2r_model with pack feature function.
  def __init__(self,
               t2r_model,
               action_size=2,
               theta=.2,
...
class ScheduledExplorationRegressionPolicy(Policy):
  ...
  # TODO(b/129782621): Replace t2r_model with pack feature function.
  def __init__(self,
               t2r_model,
               action_size=2,
               stddev_0=0.2,
